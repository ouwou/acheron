...
inline constexpr int AUDIO_SAMPLE_BYTES = sizeof(float); // 4 bytes (was 2 for int16)
...
inline constexpr int AUDIO_FRAME_SIZE = AUDIO_FRAME_SAMPLES * AUDIO_CHANNELS * AUDIO_SAMPLE_BYTES; // 7680 bytes
