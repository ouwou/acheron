...
public:
    ...
    [[nodiscard]] Discord::Voice::VoiceClient::State clientState() const;
...
private slots:
    ...
    void onVoiceClientStateChanged(Discord::Voice::VoiceClient::State state);
...
private:
    ...
    Discord::Voice::VoiceClient *voiceClient = nullptr;
